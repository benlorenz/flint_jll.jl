...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import flint_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cabf4574-4f87-5802-9a0b-e4b5b01a80fc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "flint", artifacts_toml) for e in artifacts["flint"]]
...
if best_platform === nothing
    @debug("Unable to load flint; unsupported platform $(triplet(platform_key_abi()))")
else
